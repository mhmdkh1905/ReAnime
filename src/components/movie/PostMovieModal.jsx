...
export default function PostMovieModal({ isOpen, onClose, onCreated }) {
  ...
  const handleSubmit = async () => {
    if (!title.trim() || !description.trim() || !releaseYear || !rating || !genre) {
    ...
    <div className="modalOverlay">
      <div className="modalCard">
        ...
        <div className="modalActions">
          <button className="ghostBtn" type="button" onClick={onClose} disabled={loading}>
            Cancel
          </button>
          <button className="primaryBtn" type="button" onClick={handleSubmit} disabled={loading}>
